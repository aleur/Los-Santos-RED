...
namespace LosSantosRED.lsr
{
    public class ModController
    {
        ...
        public void Setup()
        {
            ...
            Player.Setup();
            GameFiber.Yield();
            Police = new Police(World, Player, Player, Player, ModDataFileManager.Settings, Player, Time);
            GameFiber.Yield();
            Civilians = new Civilians(World, Player, Player, Player, ModDataFileManager.Settings, ModDataFileManager.Gangs);
            GameFiber.Yield();
        ...
        private void SetTaskGroups()
        {
            TaskGroups = new List<ModTaskGroup>
            {
                ...
                new ModTaskGroup("RG10:World LowPri", new List<ModTask>()
                {
                    ...
                    new ModTask(1000, "World.Events.UpdateEvents", World.Events.UpdateEvents, 6), // idk

                    new ModTask(1000, "World.Update", World.Update, 7),///????MAYBE BAD?
                }),
