...
public class BusinessMenu
{
    ...
    public BusinessMenu(string iD, string name, List<MenuItem> items)
    {
        ID = iD;
        Name = name;
        Items = items;
    }
    public BusinessMenu(string iD, string name, string groupName, List<MenuItem> items)
    {
        ID = iD;
        Name = name;
        Items = items;
    ...
    public BusinessMenu(string iD, string name, List<MenuItem> items, string groupName)
    {
        ID = iD;
        Name = name;
        Items = items;
