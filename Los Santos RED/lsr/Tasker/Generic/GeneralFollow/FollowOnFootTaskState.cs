    ...
    private void UpdateFollow()
    {
        ...
        if (!isSetFollow || followSpeed != GeneralFollow.RunSpeed || isSetForce != Player.GroupManager.BlockPermanentEvents)
        {
            ...
            unsafe
            {
                ...
                NativeFunction.CallByName<bool>("TASK_FOLLOW_TO_OFFSET_OF_ENTITY", 0, Player.Character, offsetX, offsetY, 0f, GeneralFollow.RunSpeed, -1, Settings.SettingsManager.GroupSettings.StoppingRange, true);//NativeFunction.Natives.TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, Player.Character, 3.0f, 3.0f, 0f, 0.75f, 20000, 5f, true);
