...
namespace LosSantosRED.lsr.Player.ActiveTasks
{
    public class RivalGangHitTask : GangTask, IPlayerTask
    {
        ...
        protected override void SendInitialInstructionsMessage()
        {
            ...
            List<string> Replies = TargetZone != null
                ? (HiringGangDen.IsAvailableForPlayer ? availableHiringDenWithZone : unavailableHiringDenWithZone)
                : (HiringGangDen.IsAvailableForPlayer ? availableHiringDenNoZone : unavailableHiringDenNoZone);
